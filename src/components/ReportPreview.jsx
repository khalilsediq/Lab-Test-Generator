    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50 rounded-t-2xl">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm border border-red-200 bg-red-50 text-red-700 px-2 py-0.5 rounded shadow-sm inline-block mt-1 uppercase tracking-wider font-semibold">
        ...
        <div className="p-6 bg-gray-50 rounded-b-2xl border-t border-gray-100 flex justify-end space-x-3">
          ...
          <button className="px-6 py-2 rounded-xl bg-red-600 hover:bg-red-700 text-white font-medium shadow-lg shadow-red-500/30 transition-all active:scale-95 flex items-center space-x-2">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
